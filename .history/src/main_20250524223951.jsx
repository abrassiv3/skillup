...
import ClientsChats from "./components/ClientChats.jsx";
    ...
    <AuthContextProvider>
      <Router>
        ...
        <Route element={<FlDashboardLayout />}>
          ...
          <Route path="/chats" element={ <PrivateRoute><ProtectedRoute allowedRoles={['Freelancer']}><ApplyToJob /></ProtectedRoute></PrivateRoute> } />
        </Route>
